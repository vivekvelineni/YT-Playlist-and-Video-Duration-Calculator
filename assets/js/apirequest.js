function Find() {
    ...
    var input = Rawinput.trim();
      ...
      async function VideoRequest(Vid) {
        try {  
        ...
        async function PlaylistRequest(Pid){
          try {
            var key = 'AIzaSyAKK4JLBElsC6bN1w7-TtPnlGbHZyshv5c'
            var Pdetails = []
            ...
            var response = await axios.get(turl)
            const tjson = response.data
            ...
            var response = await axios.get(purl)
        ...
        async function PVideoId(Pdetails,pvid) {
          try {
            var Pvdurs = [0,0,0,0]
            var key = 'AIzaSyAKK4JLBElsC6bN1w7-TtPnlGbHZyshv5c'
            ...
            var response = await axios.get(url)
            var pvjson = response.data
            try {
            var Prawdur = pvjson['items'][0]['contentDetails']['duration']
            } catch (error){
              continue;
            }
            var Day = ['0']; var Hour = ['0']; var Min = ['0']; var Sec = ['0']
